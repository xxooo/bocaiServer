  ...
  <div id="youxishezhi" class="content-main">
    ...
    <div class="nav">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>隐单帐号</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="nav">
...
export default {
  ...
  methods: {
    ...
    addgudong() {
      this.$router.push({name:'addhidemember'});
    },
    ...
    updateuser(item) {
      ...
      this.$router.push({name:'updatehidemember'});
    },
    hasitem(item,num) {
    ...
    async childUser() {
      ...
      let res = await this.$get(`${window.url}/admin/cuser/userList?ruleId=13&isHide=2&status=`+this.shuaixuanNum+`&shareholderClass=`+this.gudonguclass+`&generalagentClass=`+this.zongdluclass+`&agentClass=`+this.dailiuclass+`&username=`+this.gudongAccout+`&currentPage=`+this.currentPage+`&pageSize=10`);
