  ...
  <div id="youxishezhi" class="content-main">
    ...
    <div class="nav">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ name: 'daili' }">代理</el-breadcrumb-item>
    ...
    <div class="portlet portlet-add">
      <div class="tab">
        <table>
          ...
          <tr v-if="isshangji">
            <td width="20%" class="tar">总代理:</td> 
              <td class="tl">
                <p>{{fujiUserInfo.username}}</p>
              </td> 
            <td width="20%" class="tl"><p>上级总代理</p></td>
          </tr>
          <tr v-else isshangji>
            <td width="20%" class="tar">总代理:</td> 
              <td class="tl">
            ...
            <td width="20%" class="tl"><p>请选择上级总代理</p></td>
          </tr>
          <tr>
            <td width="20%" class="tar">代理帐号:</td> 
            <td class="tl">
        ...
        <table>
          ...
          <p class="tac" style="margin-top: 8px;">
            ...
            <button class="tabBtn btn btn-red" @click="$router.push({name:'daili'})">取消</button>
          </p>
      </div>
    </div>
...
export default {
  ...
  data () {
    return {
      isNew: this.$route.name == 'adddaili' ? true : false,
      childUserInfo: {},
      currentPage: 1,
