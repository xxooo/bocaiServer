    ...
    <div class="box">
      ...
      <div class="win_info">
        <ul>
          ...
          <li>● 03. 为避免纠纷，各会员在投注之后，务必进入下注明细检查。若发现任何异常，请立即与代理商联系查证，一切投注将以本公司资料库的资料为准，不得异议。如出现特殊网络情况或线路不稳定导致不能下注或下注失败。本公司概不负责。</li>
          ...
          <li class="user_winbu">
            <div>
              <el-button type="primary" size="mini" @click="$router.push({name: 'home'})">同  意</el-button>
